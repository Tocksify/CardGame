...
const ABILITY_THEMES: Record<string, [string, string, string]> = {
  ...
  chromatic: ['Prismatic Strike', 'Spectrum Burst',    'Chromatic Annihilation'],
};
...
export const CARD_TEMPLATES: CardTemplate[] = [
  ...
  // ── Rare Spells ───────────────────────────────────────────────────────────
  {
    ...
    description: 'Destroy a character with DEF 8 or less, gain its ATK as gold.',
  ...
  // ── Secret Artifacts ──────────────────────────────────────────────────────
  {
    ...
    description: 'Chromatic Creed scales with battle: all your characters gain +1 ATK per 20 total damage you have dealt this game.',
    effect: 'creed_scaling',
    rarity: 'secret', artTheme: 'chromatic',
  },
...
export const SHOP_ITEMS: ShopItemTemplate[] = [
  ...
  // ── Secret Artifact (shop) ────────────────────────────────────────────────
  { id: 'sec_creed_shop', name: 'Creed',          type: 'artifact', cost: 2000, description: 'Chromatic artifact: +1 ATK to all per 20 damage dealt this game.', cardTemplateId: 'sec_creed' },
